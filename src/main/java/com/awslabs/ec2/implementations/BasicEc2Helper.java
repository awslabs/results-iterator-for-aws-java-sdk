...
import com.awslabs.ec2.interfaces.Ec2Helper;
...
public class BasicEc2Helper implements Ec2Helper {
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(BasicEc2Helper.class);
    @Inject
    Ec2Client ec2Client;

    @Inject
    public BasicEc2Helper() {
    }
