...
public abstract class V2ResultsIteratorAbstract<T> implements ResultsIterator<T> {
    ...
    public V2ResultsIteratorAbstract(V2ReflectionHelper v2ReflectionHelper, SdkClient sdkClient, AwsRequest originalAwsRequest) {
        this.v2ReflectionHelper = v2ReflectionHelper;
        this.sdkClient = sdkClient;
    ...
    public V2ResultsIteratorAbstract(SdkClient sdkClient, Class<? extends AwsRequest> awsRequestClass) {
    ...
    public V2ResultsIteratorAbstract(SdkClient sdkClient, AwsRequest originalAwsRequest) {
        this.v2ReflectionHelper = new BasicV2ReflectionHelper();
        this.sdkClient = sdkClient;
        this.awsRequestClass = originalAwsRequest.getClass();
        this.originalAwsRequest = originalAwsRequest;
